...
class Query {
    ...
    select(...fieldPaths) {
        ...
        const options = extend_1.default(true, {}, this._queryOptions);
    ...
    isEqual(other) {
        ...
        return (is_1.default.instanceof(other, Query) && this._path.isEqual(other._path) &&
    ...
    stream() {
        ...
        const transform = through2_1.default.obj(function (chunk, encoding, callback) {
