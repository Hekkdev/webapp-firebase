...
const write_batch_2 = require("./write-batch");
...
class Firestore {
    ...
    constructor(settings) {
        ...
        this._timestampsInSnapshotsEnabled = false;
    ...
    settings(settings) {
        ...
        const mergedSettings = extend_1.default({}, this._initializationSettings, settings);
     ...
     */
    listCollections() {
        const rootDocument = new reference_2.DocumentReference(this, this._referencePath);
...
follow these steps, YOUR APP MAY BREAK.`);
    ...
    _initClientPool() {
        ...
        const clientPool = new pool_1.ClientPool(MAX_CONCURRENT_REQUESTS_PER_CLIENT, () => {
            const client = new module.exports.v1beta1(this._initializationSettings);
            ...
            return this._retry(attempts, requestTag, () => {
                return new Promise((resolve, reject) => {
                    try {
                        ...
                        const stream = gapicClient[methodName](decorated.request, decorated.gax);
                        const logStream = through2_1.default.obj(function (chunk, enc, callback) {
        ...
        return this._runRequest(gapicClient => {
            ...
            return this._retry(attempts, requestTag, () => {
                return Promise.resolve().then(() => {
                    ...
                    const transform = through2_1.default.obj((chunk, encoding, callback) => {
                        const decoratedChunk = extend_1.default(true, {}, chunk);
                    ...
                    const resultStream = bun_1.default([transform, requestStream, logStream]);
