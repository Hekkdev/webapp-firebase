...
const firestoreDB = admin.firestore();
 ...
 exports.sendMessageBack = functions.firestore.document('users/{userId}/messages/{messageId}').onCreate( (snap, context) => {
   var newValue = snap.data();
   var collection = firestoreDB.collection('users');
   var document = collection.doc(context.params.userId);
   var messagesRef = document.collection('responses').doc();
//
   return  messagesRef.set({
         name: "AI Assistant",
         text: newValue.text,
         profilePicUrl: newValue.profilePicUrl
       });
//
//
// //   const promises = [];
